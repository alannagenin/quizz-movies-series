...
class TestQuestionSeriesNumberSeasons(TestCase):
    def test_question_series_nb_seasons(self):
        # GIVEN
        ...
        self.assertEqual(question.type, 'series number seasons')
        self.assertEqual(result, 'How many seasons does the series Gimme Gimme Gimme have?')
        self.assertEqual(correct_answer, 4)
        self.assertIsInstance(question, QuestionSeriesNumberSeasons)
